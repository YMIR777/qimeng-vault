...
export function TimeCapsule({ transactions, updateTransaction }: TimeCapsuleProps) {
  ...
  const { start, end, label } = useMemo(() => getLastMonthRange(), []);
  ...
  const categoryStats = useMemo(() => {
    ...
    return Array.from(map.entries())
      .map(([category, stat]) => ({
        category,
        ...stat,
        rate: stat.total > 0 ? Math.round((stat.regret / stat.total) * 100) : 0,
      }))
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            background: '#f0ebe0',
            boxShadow: '2px 2px 5px #cdc5b8, -2px -2px 5px #fffbf5',
            cursor: 'pointer',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
        ...
        <>
          ...
          >
            <span
              style={{
                ...
                fontSize: '36px',
                color: regretRate > 50 ? '#c9923a' : '#6b9fcf',
                lineHeight: 1,
              }}
            >
              <span style={{ fontFamily: "'Courier New', monospace", fontSize: '40px' }}>
                {regretRate}
              </span>
                        ...
                        <>
                          <button
                            ...
                            style={{
                              ...
                              border: 'none',
                              background: '#f0ebe0',
                              boxShadow: '2px 2px 4px #cdc5b8, -2px -2px 4px #fffbf5',
                              color: '#c9923a',
                              cursor: 'pointer',
                            }}
                          >
                  ...
                  >
                    ...
                    >
                      <div
                        style={{
                          width: `${stat.rate}%`,
                          height: '100%',
                          background: stat.rate > 50 ? '#c9923a' : '#6b9fcf',
                          borderRadius: '2px',
                          transition: 'width 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)',
                        }}
                      />
                    ...
                    <span
                      style={{
                        ...
                        fontSize: '11px',
                        color: stat.rate > 50 ? '#c9923a' : '#6b9fcf',
                        width: '36px',
                        textAlign: 'right',
                        flexShrink: 0,
                      }}
          ...
          <div
            style={{
              padding: '14px 16px',
              borderRadius: '12px',
              background: 'rgba(107,159,207,0.06)',
              fontSize: '12px',
              color: '#3d3427',
              lineHeight: 1.6,
            }}
